            ...
            try {
                ...
                if (replacements) {
                    return Object.entries(replacements).reduce({
                        "LanguageProvider.useCallback[t]": (acc, [k, v])=>acc.replace(`{{${k}}}`, v)
                    }["LanguageProvider.useCallback[t]"], value);
                }
                return value;
            } catch (error) {
...
_s(LanguageProvider, "LbLPwPc8Hbf8Ut7G1fWC48JZHIo=");
_c = LanguageProvider;
const useLanguage = ()=>{
    _s1();
...
"[project]/src/components/cosmic-explorer/navbar.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Navbar() {
    _s();
    const { t, language, setLanguage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])();
...
_s(Navbar, "Y1G44OzOjLg42/kWGx/GPtNpVzQ=", false, function() {
    return [
...
//# sourceMappingURL=src_b568b945._.js.map